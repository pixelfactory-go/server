...
1. **GitHub Security Advisories** (Preferred): Use the [Security Advisory](https://github.com/pixelfactory-go/server/security/advisories/new) feature to privately report vulnerabilities
...
- Compromise the integrity of server operations
...
- The server library and all its components
...
- **GitHub**: https://github.com/pixelfactory-go/server/security/advisories
